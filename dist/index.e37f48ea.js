...
var _recipeViewJs = require("./views/recipeView.js"); // Fixed import
...
const controlRecipes = async function() {
    try {
        ...
        (0, _recipeViewJsDefault.default).renderError("Failed to load recipe. Please try again.");
        console.error(err);
    }
};
...
const controlAddRecipe = async function(newRecipe) {
    try {
        ...
        (0, _bookmarksViewJsDefault.default).render(_modelJs.state.bookmarks);
        // Change ID in URL and load the new recipe
        window.history.pushState(null, "", `#${_modelJs.state.recipe.id}`);
        controlRecipes(); // Ensure it loads the new recipe
        // Close form window
        setTimeout(()=>(0, _addRecipeViewJsDefault.default).toggleWindow(), (0, _configJs.MODAL_CLOSE_SEC) * 1000);
    } catch (err) {
        console.error("Upload error:", err);
        (0, _addRecipeViewJsDefault.default).renderError("Failed to upload recipe. Please try again.");
    }
};
const init = function() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ","./model.js":"Y4A21","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/paginationView.js":"6z7bi","./config.js":"k5Hzs","./views/addRecipeView.js":"i6DNj","./views/bookmarksView.js":"4Lqzq","./views/recipeView.js":"l60JC"}],"gkKU3":[function(require,module,exports) {
...
var _configJs = require("./config.js");
var _apiKeyJs = require("./apiKey.js");
...
const loadRecipe = async function(id) {
    try {
        const data = await (0, _helpersJs.AJAX)(`${(0, _configJs.API_URL)}${id}?key=${(0, _apiKeyJs.KEY)}`);
...
const uploadRecipe = async function(newRecipe) {
    try {
        ...
        const data = await (0, _helpersJs.AJAX)(`${(0, _configJs.API_URL)}?key=${(0, _apiKeyJs.KEY)}`, recipe);
        state.recipe = createRecipeObject(data);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","regenerator-runtime":"dXNgZ","./config.js":"k5Hzs","./helpers.js":"hGI1E","./apiKey.js":"9LDwg"}],"k5Hzs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./config.js":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9LDwg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "KEY", ()=>KEY);
const KEY = "791714a9-917c-464e-a5f9-ea6b09a7c101";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./View.js":"5cUXS","./previewView.js":"1FDQ6","url:../../img/icons.svg":"loVOp"}],"5cUXS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg"); // Parcel 2
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{"./View.js":"5cUXS","./previewView.js":"1FDQ6","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"l60JC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./View.js":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","fraction.js":"cNkjY"}],"cNkjY":[function(require,module,exports) {
/*
